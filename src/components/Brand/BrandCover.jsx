          ...
          <BoxTooltipTitle
            ...
            title={
              <div className="toltip-title-line">
                <span>
                  Set an image, video or GIF as a background. Your background
                  will not be visible in all layouts
                </span>{" "}
                <br /> <span>Recommended size: 1280 x 720.</span> <br /> <br />{" "}
                <span>Max image file size: 20 MB</span> <br /> <br />{" "}
                <span>Max video length: 1 minute.</span> <br /> <br />{" "}
                <span>File types: .png, .jpeg, .jpg, .gif, .mp4..</span> <br />{" "}
                <span>Video backgrounds will play on a loop with no audio</span>{" "}
                <br />{" "}
              </div>
            }
          >
